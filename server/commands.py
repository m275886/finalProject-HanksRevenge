...
COMMAND_SPECS = [
    ...
    {'id': CMD_INSPECT_TOKEN, 'name': 'inspect-token', 'usage': 'token-privileges <pid>', 'description': 'Return all privileges present on a target process token'},
    ...
    {'id': CMD_HOST_NAME, 'name': 'Host-Name', 'usage': 'Host-Name', 'description': 'Tells user the host name'},
